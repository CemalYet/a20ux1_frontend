      ...
      <v-container>
        ...
        >
          <v-col
              ...
              sm="3"
          >
            <leaf v-bind:leafSVG="leafSVG" v-bind:userData="userData"/>
          </v-col>
        </v-row>
      </v-container>
      <br/>
